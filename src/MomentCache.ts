...
class MomentCache {
    ...
    public static _instance: MomentCache | null = null;
    ...
    public static get instance() {
        if (MomentCache._instance === null) {
            MomentCache._instance = new MomentCache();
        }
        return MomentCache._instance;
    }
}

export default MomentCache.instance;
